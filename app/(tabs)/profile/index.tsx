...
export default function ProfileScreen() {
  ...
  if (!user) return null; // Evita render si no hay sesión
  if (loading || !profile) {
    return (
    ...
    <SafeAreaView style={styles.container}>
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <TouchableOpacity
          ...
          onPress={() => router.push({ pathname: '/train/performance' })}
        >
...
const styles = StyleSheet.create({
  ...
  modalContainer: {
    ...
    alignItems: 'center',
    zIndex: 2, // Asegúrate de que esté por encima del fondo
  },
  modalMessage: {
    position: 'absolute', // Esto hace que el mensaje esté encima
    top: -30, // Ajusta la posición del texto hacia arriba
    left: 10,
    right: 10,
    fontSize: 18,
    fontWeight: 'bold',
  ...
  modalButton: {
    ...
    backgroundColor: 'transparent',  // Sin fondo, solo el icono
    padding: 10,  // Ajusta el padding para mayor área de clic
  },
  modalButtonText: {
    fontSize: 16,
    color: '#FFFFFF',
